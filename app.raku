...
my $application = route {
    ...
    post -> 'queue', :%params {
      ...
      my $default-rakudo-version-commit = "45b4e6464d5437526aac6fa0c0822c2c90c0cb2c";

      my %rakudo-version-to-sha = %(

        "default" =>  $default-rakudo-version-commit,
        "2020.12" =>  $default-rakudo-version-commit,
        "2020.11" =>  "34faae566b713e83b7291dfae716cb8bd161e040",
      ...
      request-body -> (:$code, :$modules, :$os = "debian", :$rakudo_version? = "default", :$sha?, :$client = "cli", :$description, :$skip_zef = "off", :$with_profile = "off"  ) {
        ...
        if $is-error {
          ...
          for $rakudo-versions.split(',') -> $rv {
            ...
            $trigger = queue-build %(
              ...
              with-profile => $with_profile eq "on" ?? True !! False, 
            );
